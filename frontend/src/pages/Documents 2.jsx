              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-light-primary dark:bg-dark-primary">
                    <tr>
                      <th className="text-left p-4 text-light-onSurface dark:text-dark-onSurface font-semibold">Tên file</th>
                      <th className="text-left p-4 text-light-onSurface dark:text-dark-onSurface font-semibold">Kích thước</th>
                      <th className="text-left p-4 text-light-onSurface dark:text-dark-onSurface font-semibold">Loại file</th>
                      <th className="text-left p-4 text-light-onSurface dark:text-dark-onSurface font-semibold">Ngày upload</th>
